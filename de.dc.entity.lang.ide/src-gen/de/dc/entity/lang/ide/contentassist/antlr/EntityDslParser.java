 ...
 */
package de.dc.entity.lang.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import de.dc.entity.lang.ide.contentassist.antlr.internal.InternalEntityDslParser;
...
public class EntityDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EntityDslGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getProjectFXAccess().getElementsAlternatives_0(), "rule__ProjectFX__ElementsAlternatives_0");
			...
			builder.put(grammarAccess.getSpringMetroAccess().getGroup(), "rule__SpringMetro__Group__0");
			builder.put(grammarAccess.getSpringMetroAccess().getGroup_1(), "rule__SpringMetro__Group_1__0");
			builder.put(grammarAccess.getSpringMetroAccess().getGroup_5(), "rule__SpringMetro__Group_5__0");
			builder.put(grammarAccess.getSpringMetroAccess().getGroup_6(), "rule__SpringMetro__Group_6__0");
			builder.put(grammarAccess.getSpringMetroAccess().getGroup_7(), "rule__SpringMetro__Group_7__0");
			builder.put(grammarAccess.getSpringMetroAccess().getGroup_7_2(), "rule__SpringMetro__Group_7_2__0");
			builder.put(grammarAccess.getPageContainerAccess().getGroup(), "rule__PageContainer__Group__0");
			builder.put(grammarAccess.getPageContainerAccess().getGroup_3(), "rule__PageContainer__Group_3__0");
			builder.put(grammarAccess.getPageContainerAccess().getGroup_3_1(), "rule__PageContainer__Group_3_1__0");
			builder.put(grammarAccess.getPageContainerAccess().getGroup_4(), "rule__PageContainer__Group_4__0");
			builder.put(grammarAccess.getPageContainerAccess().getGroup_4_1(), "rule__PageContainer__Group_4_1__0");
			builder.put(grammarAccess.getPageAccess().getGroup(), "rule__Page__Group__0");
			builder.put(grammarAccess.getFxmlPageAccess().getGroup(), "rule__FxmlPage__Group__0");
			builder.put(grammarAccess.getMetroAccess().getGroup(), "rule__Metro__Group__0");
			builder.put(grammarAccess.getMetroAccess().getGroup_1(), "rule__Metro__Group_1__0");
			builder.put(grammarAccess.getMetroAccess().getGroup_5(), "rule__Metro__Group_5__0");
			builder.put(grammarAccess.getMetroAccess().getGroup_6(), "rule__Metro__Group_6__0");
			builder.put(grammarAccess.getMetroAccess().getGroup_7(), "rule__Metro__Group_7__0");
			builder.put(grammarAccess.getMetroAccess().getGroup_8(), "rule__Metro__Group_8__0");
			builder.put(grammarAccess.getMetroAccess().getGroup_8_2(), "rule__Metro__Group_8_2__0");
			...
			builder.put(grammarAccess.getFXControlAccess().getGroup(), "rule__FXControl__Group__0");
			builder.put(grammarAccess.getFXControlAccess().getGroup_2(), "rule__FXControl__Group_2__0");
			builder.put(grammarAccess.getFXControlAccess().getGroup_3(), "rule__FXControl__Group_3__0");
			builder.put(grammarAccess.getFXControlAccess().getGroup_4(), "rule__FXControl__Group_4__0");
			builder.put(grammarAccess.getFXControlAccess().getGroup_5(), "rule__FXControl__Group_5__0");
			builder.put(grammarAccess.getFXControlAccess().getGroup_6(), "rule__FXControl__Group_6__0");
			builder.put(grammarAccess.getFXControlAccess().getGroup_7(), "rule__FXControl__Group_7__0");
			...
			builder.put(grammarAccess.getSQLStatementAccess().getGroup(), "rule__SQLStatement__Group__0");
			builder.put(grammarAccess.getSQLStatementAccess().getGroup_3(), "rule__SQLStatement__Group_3__0");
			builder.put(grammarAccess.getSQLStatementAccess().getGroup_4(), "rule__SQLStatement__Group_4__0");
			builder.put(grammarAccess.getSQLStatementAccess().getGroup_5(), "rule__SQLStatement__Group_5__0");
			...
			builder.put(grammarAccess.getProjectFXAccess().getElementsAssignment(), "rule__ProjectFX__ElementsAssignment");
			builder.put(grammarAccess.getSpringMetroAccess().getPackagePathAssignment_1_1(), "rule__SpringMetro__PackagePathAssignment_1_1");
			builder.put(grammarAccess.getSpringMetroAccess().getNameAssignment_3(), "rule__SpringMetro__NameAssignment_3");
			builder.put(grammarAccess.getSpringMetroAccess().getTitleAssignment_5_1(), "rule__SpringMetro__TitleAssignment_5_1");
			builder.put(grammarAccess.getSpringMetroAccess().getSubtitleAssignment_6_1(), "rule__SpringMetro__SubtitleAssignment_6_1");
			builder.put(grammarAccess.getSpringMetroAccess().getElementsAssignment_7_1(), "rule__SpringMetro__ElementsAssignment_7_1");
			builder.put(grammarAccess.getSpringMetroAccess().getElementsAssignment_7_2_1(), "rule__SpringMetro__ElementsAssignment_7_2_1");
			builder.put(grammarAccess.getPageContainerAccess().getPagesAssignment_3_0(), "rule__PageContainer__PagesAssignment_3_0");
			builder.put(grammarAccess.getPageContainerAccess().getPagesAssignment_3_1_1(), "rule__PageContainer__PagesAssignment_3_1_1");
			builder.put(grammarAccess.getPageContainerAccess().getPagesAssignment_4_0(), "rule__PageContainer__PagesAssignment_4_0");
			builder.put(grammarAccess.getPageContainerAccess().getPagesAssignment_4_1_1(), "rule__PageContainer__PagesAssignment_4_1_1");
			builder.put(grammarAccess.getPageAccess().getNameAssignment_2(), "rule__Page__NameAssignment_2");
			builder.put(grammarAccess.getPageAccess().getControllerAssignment_5(), "rule__Page__ControllerAssignment_5");
			builder.put(grammarAccess.getFxmlPageAccess().getNameAssignment_2(), "rule__FxmlPage__NameAssignment_2");
			builder.put(grammarAccess.getFxmlPageAccess().getFxmlAssignment_5(), "rule__FxmlPage__FxmlAssignment_5");
			builder.put(grammarAccess.getFxmlPageAccess().getControllerAssignment_7(), "rule__FxmlPage__ControllerAssignment_7");
			builder.put(grammarAccess.getMetroAccess().getPackagePathAssignment_1_1(), "rule__Metro__PackagePathAssignment_1_1");
			builder.put(grammarAccess.getMetroAccess().getNameAssignment_3(), "rule__Metro__NameAssignment_3");
			builder.put(grammarAccess.getMetroAccess().getTitleAssignment_5_1(), "rule__Metro__TitleAssignment_5_1");
			builder.put(grammarAccess.getMetroAccess().getSubtitleAssignment_6_1(), "rule__Metro__SubtitleAssignment_6_1");
			builder.put(grammarAccess.getMetroAccess().getMainNavigationItemAssignment_7_1(), "rule__Metro__MainNavigationItemAssignment_7_1");
			builder.put(grammarAccess.getMetroAccess().getNavigationItemsAssignment_8_1(), "rule__Metro__NavigationItemsAssignment_8_1");
			builder.put(grammarAccess.getMetroAccess().getNavigationItemsAssignment_8_2_1(), "rule__Metro__NavigationItemsAssignment_8_2_1");
			builder.put(grammarAccess.getEntityAccess().getPackagePathAssignment_1_1(), "rule__Entity__PackagePathAssignment_1_1");
			...
			builder.put(grammarAccess.getEntityAccess().getShowDetailsPanelAssignment_7_1(), "rule__Entity__ShowDetailsPanelAssignment_7_1");
			builder.put(grammarAccess.getEntityAccess().getShowSearchPanelAssignment_8_1(), "rule__Entity__ShowSearchPanelAssignment_8_1");
			builder.put(grammarAccess.getEntityAccess().getGenerateDemoAssignment_9_1(), "rule__Entity__GenerateDemoAssignment_9_1");
			builder.put(grammarAccess.getEntityAccess().getFieldAssignment_10_0(), "rule__Entity__FieldAssignment_10_0");
			builder.put(grammarAccess.getEntityAccess().getFieldAssignment_10_1(), "rule__Entity__FieldAssignment_10_1");
			builder.put(grammarAccess.getEntityAccess().getRepositoryAssignment_11(), "rule__Entity__RepositoryAssignment_11");
			...
			builder.put(grammarAccess.getFieldAccess().getIsClobAssignment_5_1(), "rule__Field__IsClobAssignment_5_1");
			builder.put(grammarAccess.getFieldAccess().getRequiredAssignment_6_1(), "rule__Field__RequiredAssignment_6_1");
			builder.put(grammarAccess.getFieldAccess().getUseByTableViewAssignment_7_1(), "rule__Field__UseByTableViewAssignment_7_1");
			builder.put(grammarAccess.getFieldAccess().getUseByRepositoryAssignment_8_1(), "rule__Field__UseByRepositoryAssignment_8_1");
			builder.put(grammarAccess.getFieldAccess().getControlAssignment_10(), "rule__Field__ControlAssignment_10");
			builder.put(grammarAccess.getFXControlAccess().getNameAssignment_2_1(), "rule__FXControl__NameAssignment_2_1");
			builder.put(grammarAccess.getFXControlAccess().getControlAssignment_3_1(), "rule__FXControl__ControlAssignment_3_1");
			builder.put(grammarAccess.getFXControlAccess().getColumnWidthAssignment_4_1(), "rule__FXControl__ColumnWidthAssignment_4_1");
			builder.put(grammarAccess.getFXControlAccess().getBindingAssignment_5_1(), "rule__FXControl__BindingAssignment_5_1");
			builder.put(grammarAccess.getFXControlAccess().getTooltipAssignment_6_1(), "rule__FXControl__TooltipAssignment_6_1");
			builder.put(grammarAccess.getFXControlAccess().getDescriptionAssignment_7_1(), "rule__FXControl__DescriptionAssignment_7_1");
			builder.put(grammarAccess.getRepositoryAccess().getJdbcUrlAssignment_3_1(), "rule__Repository__JdbcUrlAssignment_3_1");
			builder.put(grammarAccess.getRepositoryAccess().getGenerateDummyInsertAssignment_4_1(), "rule__Repository__GenerateDummyInsertAssignment_4_1");
			builder.put(grammarAccess.getRepositoryAccess().getStatementAssignment_5_0(), "rule__Repository__StatementAssignment_5_0");
			builder.put(grammarAccess.getRepositoryAccess().getStatementAssignment_5_1(), "rule__Repository__StatementAssignment_5_1");
			builder.put(grammarAccess.getSQLStatementAccess().getNameAssignment_3_1(), "rule__SQLStatement__NameAssignment_3_1");
			builder.put(grammarAccess.getSQLStatementAccess().getQueryAssignment_4_1(), "rule__SQLStatement__QueryAssignment_4_1");
			builder.put(grammarAccess.getSQLStatementAccess().getReturnValueAssignment_5_1(), "rule__SQLStatement__ReturnValueAssignment_5_1");
