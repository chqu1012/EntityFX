...
public class EntityDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EntityDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFieldAccess().getUseByTableViewAssignment_6_1(), "rule__Field__UseByTableViewAssignment_6_1");
			builder.put(grammarAccess.getFieldAccess().getUseByRepositoryAssignment_7_1(), "rule__Field__UseByRepositoryAssignment_7_1");
			builder.put(grammarAccess.getFieldAccess().getControlAssignment_9(), "rule__Field__ControlAssignment_9");
