...
public class ExtendedDemoApplicationPaneTemplate implements IGenerator<Entity> {
  ...
  public String gen(final Entity t) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("createCenterTab(\"");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("createRightTab(\"");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("createCenterTab(\"Preferences\", webView);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("protected void createRightTab(String name, Node node) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("tabPaneRight.getTabs().add(createTab(name, node));");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("protected void createLeftTab(String name, Node node) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("tabPaneLeft.getTabs().add(createTab(name, node));");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("protected void createCenterTab(String name, Node node) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("tabPaneCenter.getTabs().add(createTab(name, node));");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("protected void createBottomTab(String name, Node node) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("tabPaneBottom.getTabs().add(createTab(name, node));");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private Tab createTab(String name, Node node) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("Tab tab = new Tab(name);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("AnchorPane.setBottomAnchor(node, 0d);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("AnchorPane.setTopAnchor(node, 0d);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("AnchorPane.setRightAnchor(node, 0d);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("AnchorPane.setLeftAnchor(node, 0d);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("AnchorPane anchorPane = new AnchorPane(node);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("tab.setContent(anchorPane);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return tab;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
