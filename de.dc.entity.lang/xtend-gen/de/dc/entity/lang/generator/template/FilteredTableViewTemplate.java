...
public class FilteredTableViewTemplate implements IGenerator<Entity> {
  ...
  public String gen(final Entity t) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("export(EventLogExporter.Type.HTML);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}else if (source == menuItemExcel) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("export(EventLogExporter.Type.EXCEL);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}else if (source == menuItemText) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("export(EventLogExporter.Type.TEXT);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("Exporter.Type type) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
