...
public class SpringFormularTemplate implements IGenerator<Entity> {
  @Override
  ...
  public String gen(final Entity t) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("@Autowired private ");
    _builder.append(name, "\t");
      ...
      for(final Field field : _field) {
        {
          ...
          if (_tripleNotEquals) {
            ...
            _builder.append(" ");
            String _firstLower_1 = StringExtensions.toFirstLower(controlName);
            ...
            _builder.newLineIfNotEmpty();
            _builder.append("\t\t");
            String _firstLower_2 = StringExtensions.toFirstLower(controlName);
            ...
            _builder.newLineIfNotEmpty();
            {
              if (((control.getBinding() == null) || Objects.equal(control.getBinding(), Binding.TEXT_PROPERTY))) {
                _builder.append("\t\t");
                String _firstLower_3 = StringExtensions.toFirstLower(controlName);
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("getChildren().add(submitButton);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("context.getMasterData().add(");
