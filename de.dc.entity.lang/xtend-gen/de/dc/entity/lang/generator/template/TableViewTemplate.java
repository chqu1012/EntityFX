...
public class TableViewTemplate implements IGenerator<Entity> {
  @Override
  ...
  public String gen(final Entity t) {
    ...
    _builder.append(name, "\t");
    _builder.append("> filteredData = new FilteredList<>(masterData, p->true);");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("setItems(context.getFilteredMasterData());");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
