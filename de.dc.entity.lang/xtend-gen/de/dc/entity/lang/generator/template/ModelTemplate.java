...
public class ModelTemplate implements IGenerator<Entity> {
  @Override
  ...
  public String gen(final Entity t) {
    ...
    final String parameter = IterableExtensions.<String>reduce(IterableExtensions.<Field, String>map(IterableExtensions.<Field>filter(t.getField(), _function), _function_1), _function_2);
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("public ");
