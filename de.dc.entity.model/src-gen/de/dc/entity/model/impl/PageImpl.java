 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.entity.model.impl.PageImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.dc.entity.model.impl.PageImpl#getController <em>Controller</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageImpl extends AbstractModelImpl implements Page {
	/**
	...
	public NotificationChain basicSetController(JvmTypeReference newController, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModelPackage.PAGE__CONTROLLER, oldController, newController);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setController(JvmTypeReference newController) {
		if (newController != controller) {
			...
			if (controller != null)
				msgs = ((InternalEObject) controller).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ModelPackage.PAGE__CONTROLLER, null, msgs);
			if (newController != null)
				msgs = ((InternalEObject) newController).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ModelPackage.PAGE__CONTROLLER, null, msgs);
			msgs = basicSetController(newController, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PAGE__CONTROLLER, newController,
					newController));
	}
