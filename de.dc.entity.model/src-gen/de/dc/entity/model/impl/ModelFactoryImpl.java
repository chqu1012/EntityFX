...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	 ...
	 */
	@Override
	public FXControl createFXControl() {
		FXControlImpl fxControl = new FXControlImpl();
		return fxControl;
	}
	 ...
	 */
	@Override
	public Binding createBinding(String literal) {
		Binding result = Binding.get(literal);
		if (result == null)
			throw new IllegalArgumentException("The value '" + literal + "' is not a valid enumerator of '"
					+ ModelPackage.Literals.BINDING.getName() + "'");
		return result;
	}
	...
	public Binding createBindingFromString(EDataType eDataType, String initialValue) {
		return createBinding(initialValue);
	}
	 ...
	 */
	@Override
	public String convertBinding(Binding instanceValue) {
	...
	public String convertBindingToString(EDataType eDataType, Object instanceValue) {
		return convertBinding((Binding) instanceValue);
	}
